...
function closeAllMenus() {
  ...
  header.style.cssText = 'background:linear-gradient(to left, rgba(26, 106, 255, 0.5), #fff, #fff 80%, rgba(163, 51, 255, 0.52));';
...
//togglep.forEach(p => p.classList.toggle('dark-mode'));
...
//'click', () => {
//toggles.forEach(toggle => {
//toggle.style.background='linear-gradient(to right, #003392ff, #7c00c4ff)';})
//togglep.forEach(toggle => toggle.classList.add('dark-text'));
//drk.style.background='#b155fd36';
